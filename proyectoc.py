...
def modabot(texto_entrada, dest_language):
    ...
    for intent in intents:
        ...
        elif intent['tag'] == "clima":
            respuesta = recommend_clothing("sunny", dest_language)
            translated_response = translate_text(respuesta, dest_language)
        elif intent['tag'] == "recomendación de moda":
            respuesta = recommend_clothing("sunny", dest_language)
            translated_response = translate_text(respuesta, dest_language)
        else:
            respuesta = "No estoy seguro de entender lo que quieres decir. ¿Podrías reformular tu pregunta?"
            translated_response = translate_text(respuesta, dest_language)
...
def principal():
    ...
    st.write("Bienvenido a ModaBot. Por favor, escriba un mensaje y presione Enter para iniciar la conversación. Sea lo más específico posible, se responde sobre los siguientes temas: Presupuesto, accesorios, zapatos, colores.")
