...
intents = [
    ...
    {
        "tag": "color",
        "patterns": ["¿Cuál es tu color favorito?", "¿Qué colores están de moda?", "¿Qué color debo usar?", "¿Qué colores combinan bien?", "Que colores estan de moda", "Que colores me recomiendas", "colores en tendencia"],
        "responses": ["Como chatbot, realmente no tengo un color favorito, pero te puedo decir que algunos colores populares esta temporada son los pasteles, colores brillantes y neutros.", 
                      ...
                      "El colore verde menta, es un tono suave y fresco, perfecto para la primavera y el verano, y se ha vuelto popular en la moda, la decoración del hogar y el diseño gráfico",
                      "El amarillo mostaza, es un tono de amarillo oscuro y saturado que aporta un toque de alegría y originalidad. Es un color que se ha visto en pasarelas de moda y en accesorios para el hogar.",
                      "El azul marino, un clásico que nunca pasa de moda, el azul marino es un color versátil que funciona bien en cualquier temporada y en una amplia variedad de prendas de vestir y accesorios."]
    },
 ...
 
    {
        ...
        "patterns": ["¿Cuáles son algunos colores primarios de moda?", "¿Cómo puedo combinar colores primarios en mi outfit?", "¿Qué colores primarios son más populares esta temporada?", "Moda de colores primarios", "Colores primarios", "combinación de colores"],
    ...
    
    {
        ...
        "patterns": ["¿Qué colores combinan bien con el amarillo?", "¿Cómo puedo combinar el amarillo en mi outfit?", "¿Qué colores puedo usar para resaltar el amarillo?", "Combinaciones de colores con amarillo", "Colores que combinan con amarillo", "combinación de colores"],
